...
describe('UserService', () => {
    ...
    describe('获取用户信息', () => {
        ...
        it('TC-USER-002: 获取用户信息 - 用户不存在', async () => {
            ...
            await expect(service.getProfile(userId)).rejects.toThrow(common_1.NotFoundException);
    ...
    describe('更新用户选择', () => {
        ...
        it('TC-USER-010: 更新用户选择 - 用户不存在', async () => {
            ...
            mockPrismaService.user.findUnique.mockResolvedValue(null);
            await expect(service.updateSelection(userId, dto)).rejects.toThrow(common_1.NotFoundException);
        });
